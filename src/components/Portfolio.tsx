...
const portfolioItems = [
    { title: 'Gym Reel', imageUrl: 'https://picsum.photos/seed/gym/500/400' },
    { title: 'Cafe Feature', imageUrl: 'https://picsum.photos/seed/cafe/500/400' },
    { title: 'Recovery Studio Promo', imageUrl: 'https://picsum.photos/seed/studio/500/400' },
    { title: 'Product Showcase', imageUrl: 'https://picsum.photos/seed/product/500/400' },
    { title: 'Local Event Highlight', imageUrl: 'https://picsum.photos/seed/event/500/400' },
    { title: 'Brand Intro', imageUrl: 'https://picsum.photos/seed/brand/500/400' },
];
