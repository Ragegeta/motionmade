        ...
        <section id="contact" className="py-20 md:py-32">
            <div className="container mx-auto px-6">
                <div className="text-center mb-16">
                    <h2 className="text-4xl md:text-5xl font-bold text-slate-100 mb-4">Get the Attention You Deserve</h2>
                ...
                <div className="max-w-2xl mx-auto">
                    <form onSubmit={handleSubmit} className="space-y-6">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div>
                                <label htmlFor="company" className="block text-sm font-medium text-slate-300">Company / Brand</label>
                                <input
                                    type="text"
                                    name="company"
                                    id="company"
                             ...
                             <div>
                                <label htmlFor="phone" className="block text-sm font-medium text-slate-300">TikTok Handle <span className="text-slate-500">(Optional)</span></label>
                                <input
                                    type="text"
                                    name="phone"
                                    id="phone"
                        ...
                        <div>
                            <label htmlFor="message" className="block text-sm font-medium text-slate-300">Tell us about your business goals</label>
                            <textarea
                                name="message"
                                id="message"
                                rows={4}
            ...
            <footer className="mt-20 border-t border-slate-800 pt-8">
                <div className="container mx-auto px-6 text-center text-slate-400">
                    <div className="flex justify-center space-x-6 mb-4">
                        <a href="#" className="text-white hover:text-pink-400 transition-colors duration-300 transform hover:scale-110"><TiktokIcon /></a>
                        <a href="#" className="hover:text-pink-400 transition-colors duration-300"><InstagramIcon /></a>
                    </div>
